view: arch_psdw_views_invoice_line_hv {
  sql_table_name: `PSDW.ARCH_PSDW_VIEWS_INVOICE_LINE_HV`
    ;;
  ...
  dimension_group: hdp_start_date_part {
    type: time
    timeframes: [
      raw,
      date,
