view: return_reason_cv {
  sql_table_name: `VI0_PHM_SDW_NP.RETURN_REASON_CV`
    ;;
  ...
  dimension: rtrn_reason_desc {
    type: string
    sql: ${TABLE}.RTRN_REASON_DESC ;;
  }

  dimension: rtrn_reason_id {
    type: string
    sql: ${TABLE}.RTRN_REASON_ID ;;
  }
