view: arch_psdw_views_ship_to_account_hv {
  sql_table_name: `PSDW.ARCH_PSDW_VIEWS_SHIP_TO_ACCOUNT_HV`
    ;;
  ...
  dimension: sap_customer_nam {
    type: string
    sql: ${TABLE}.sap_customer_nam ;;
  }

  dimension: sap_customer_num {
    type: string
    sql: ${TABLE}.sap_customer_num ;;
  }

  dimension: sap_payer_nam {
    type: string
    sql: ${TABLE}.sap_payer_nam ;;
  }

  dimension: sap_payer_num {
    type: string
    sql: ${TABLE}.sap_payer_num ;;
  }
