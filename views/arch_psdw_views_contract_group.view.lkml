view: arch_psdw_views_contract_group {
  sql_table_name: `PSDW.ARCH_PSDW_VIEWS_CONTRACT_GROUP`
    ;;
  ...
  dimension: contract_type{
    type: string
    sql: case when ${cntrct_group_num} = 0 then 'Off Contract' else 'On Contract' end;;
  }
}
