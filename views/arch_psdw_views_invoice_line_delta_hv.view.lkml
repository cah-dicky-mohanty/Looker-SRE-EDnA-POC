view: arch_psdw_views_invoice_line_delta_hv {
  sql_table_name: `PSDW.ARCH_PSDW_VIEWS_INVOICE_LINE_DELTA_HV`
    ;;
  ...
  dimension: delta_type_cde {
    type: number
    sql: ${TABLE}.delta_type_cde ;;
  }
  ...
  dimension: rcncl_process_type_cde {
    type: number
    sql: ${TABLE}.rcncl_process_type_cde ;;
  }
