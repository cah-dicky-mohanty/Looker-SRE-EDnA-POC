view: arch_psdw_dl31_holdout_dashboard_historic_comments_hv {
  sql_table_name: `PSDW.ARCH_PSDW_DL31_HOLDOUT_DASHBOARD_HISTORIC_COMMENTS_HV`
    ;;
  ...
  dimension: count_arch_psdw_dl31_holdout_dashboard_historic_comments_hv {
    type: number
    sql: ${TABLE}.count ;;
  }
