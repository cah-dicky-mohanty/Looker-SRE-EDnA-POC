view: arch_psdw_views_acct_route_rlt_hv {
  sql_table_name: `PSDW.ARCH_PSDW_VIEWS_ACCT_ROUTE_RLT_HV`
    ;;

  dimension: cutoff_tim {
    type: number
    sql: ${TABLE}.cutoff_tim ;;
  }
  ...
  dimension: ovrd_cutoff_flg {
    type: string
    sql: ${TABLE}.ovrd_cutoff_flg ;;
  }
