view: arch_psdw_dl31_holdout_holdout_results_hv {
  sql_table_name: `PSDW.ARCH_PSDW_DL31_HOLDOUT_HOLDOUT_RESULTS_HV`
    ;;
  ...
  dimension: ttl_order_qty {
    type: number
    sql: ${TABLE}.ttl_order_qty ;;
  }

  dimension: ttl_ship_qty {
    type: number
    sql: ${TABLE}.ttl_ship_qty ;;
  }
