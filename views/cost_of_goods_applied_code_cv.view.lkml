view: cost_of_goods_applied_code_cv {
  sql_table_name: `VI0_PHM_SDW_NP.COST_OF_GOODS_APPLIED_CODE_CV`
    ;;

  dimension: cogs_apply_desc {
    type: string
    sql: ${TABLE}.COGS_APPLY_DESC ;;
  }

  dimension: cogs_apply_id {
    type: string
    sql: ${TABLE}.COGS_APPLY_ID ;;
  }
